            ...
            for (const side of sides) {
                for (const leverage of leverageValues) {
                    const funding = side == 'long'
                        ? await (0, dispatcher_1.fundingLongInfo)(asset.mt5Ticker, broker)
                        : await (0, dispatcher_1.fundingShortInfo)(asset.mt5Ticker, broker);
                    ...
                    const row = {
                        ...
                        leverage: leverage,
                        maxNotional: 100,
                        minAmount: await (0, dispatcher_1.minAmountAssetInfo)(asset.mt5Ticker, broker),
                        maxAmount: await (0, dispatcher_1.maxAmountAssetInfo)(asset.mt5Ticker, broker),
                        precision: await (0, dispatcher_1.precisionInfo)(asset.mt5Ticker, broker),
